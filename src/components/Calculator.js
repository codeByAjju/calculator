...
const Calculator = () => {
  ...
  return (
    <div className="calculator col-lg-4 mt-3" style={{borderRadius:70,backgroundColor:"dark"}}>
      ...
      <div className="buttons mt-2 text-center" style={{alignItems:"center"}}>
        ...
        <button className='bg-warning' on Click={() => handleButtonPress('-')}>-</button>
        <br/>
        ...
        <button className='bg-warning' onClick={() => handleButtonPress('/')}>/</button>
        <br/>
        <button className='bg-warning' onClick={handleBack}>X</button>
      </div>
    </div>
  );
};
